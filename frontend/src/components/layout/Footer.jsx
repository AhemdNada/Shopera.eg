        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <Link to="/" className="flex items-center gap-1 mb-4">
              <span className="text-2xl font-bold text-red-600">Shopera</span>
              <span className="text-2xl font-bold text-white">.eg</span>
            </Link>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted online shopping destination in Egypt. Quality products, fast delivery, and exceptional service.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-6">
              <a 
                href="#" 
                className="text-gray-400 hover:text-[#FF3B3B] transition-colors"
                aria-label="Facebook"
              >
        ...
        <div className="border-t border-gray-800 mt-10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {new Date().getFullYear()} Shopera.eg. All rights reserved.
            </p>
