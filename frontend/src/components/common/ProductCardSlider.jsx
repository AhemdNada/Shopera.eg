    ...
    <div className="productItem shadow-lg rounded-md overflow-hidden border border-[rgba(0,0,0,0.08)] bg-white transition-transform duration-200 hover:-translate-y-0.5">
      <div className="group imgWrapper w-[100%] overflow-hidden rounded-md rounded-bl-none rounded-br-none relative">
        ...
        <div className="actions absolute top-[-20px] right-[5px] z-50 flex items-center gap-2 flex-col w-[50px] transition-all duration-300 group-hover:top-[15px] opacity-0 group-hover:opacity-100">
          <button
            className="w-[35px] h-[35px] min-w-[35px] rounded-full bg-white text-black hover:bg-primary hover:text-white group transition-colors flex items-center justify-center focus:outline-none focus:ring-0"
            type="button"
            aria-label="Compare"
          >
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-[18px] text-black group-hover:text-white" height="1em" width="1em" aria-hidden="true">
          ...
          <button
            ...
            aria-label="Share"
          >
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="text-[18px] text-black group-hover:text-white" height="1em" width="1em" aria-hidden="true">
      ...
      <div className="info p-3 py-5 relative pb-[50px] h-[190px]">
        ...
        <div className="!absolute bottom-[15px] left-0 pl-3 pr-3 w-full">
          <button
            ...
            className="btn-org addToCartBtn btn-border flex w-full btn-sm gap-2 bg-transparent border-2 border-red-500 hover:bg-red-50 text-red-500 px-3 py-2 rounded text-[12px] font-[600] transition-colors items-center justify-center focus:outline-none focus:ring-0"
            type="button"
